...
const Js=() => {
  ...
  const allLevels = {
    ...
    intermediate: [
      ...
      {
        question: "Which of the following methods converts JSON to a JavaScript object?",
      ...
      {
        question: "What does 'this' keyword refer to inside a method?",
        options: [
          "The global object",
      ...
      {
        question: "Which of the following will create a new array by transforming each element?",
        options: ["map()", "filter()", "reduce()", "forEach()"],
        correctAnswer: "map()",
      },
      {
        question: "Which of the following is true about 'let' and 'var'?",
        options: [
        ...
        correctAnswer: "'var' has function scope, 'let' has block scope",
      },
      {
      ...
      },
      {
        ...
        options: ["undefined", "object", "null", "boolean"],
    ...
    advanced: [
      {
        ...
        options: [
          ...
          "Events are blocked from propagating",
          "Events only trigger on the target element",
        ],
        correctAnswer: "Events propagate from the target element up to the root",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: "A way to handle asynchronous operations",
      },
      {
      ...
      {
        question: "Which of the following is true about the 'async' function?",
        options: [
          "It always returns a Promise",
          "It blocks the main thread",
          "It executes synchronously",
          "It only works with callbacks",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "Modifies the prototype of an object",
        ],
        correctAnswer: "Creates a new function with 'this' bound to a specific object",
      },
      {
        question: "Which statement is true about JavaScript prototypes?",
        options: [
          "Every object has a prototype",
          "Prototype is a type of function",
          "Prototype is used for variable declaration",
          "Prototype is deprecated",
        ],
        correctAnswer: "Every object has a prototype",
      },
      {
      ...
      },
      {
        ...
        options: ["event.preventDefault()", "event.stopPropagation()", "event.cancel()", "event.block()"],
